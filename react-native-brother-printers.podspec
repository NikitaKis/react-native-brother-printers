...
Pod::Spec.new do |s|
  s.name         = "react-native-brother-printers-v2"
  s.version      = package["version"]
  s.summary      = package["description"]
  s.description  = <<-DESC
                  The iOS portion of the wrapper for using brother printers with react native
                   DESC
  s.homepage     = "https://github.com/NikitaKis/react-native-brother-printers"
  # brief license entry:
  s.license      = "MIT"
  ...
  s.platforms    = { :ios => "9.0" }
  s.source       = { :git => "https://github.com/NikitaKis/react-native-brother-printers.git", :tag => "#{s.version}" }
